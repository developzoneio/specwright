...
> 14 slash commands, 6 specialized subagents, 5 guard-rail hooks, 10 templates, 11 reusable skills - all under the `sd:` namespace, stack-agnostic, cross-platform, and ready to drop into any project.
...
| **5 cross-platform hooks** | `session-context`, `prompt-router`, `spec-gate`, `subagent-retro`, `precompact-state` (PowerShell + bash) |
...
|---|---|---|
| Claude Code CLI | Latest as of Aug 2026 | Hook contract: `SessionStart`, `UserPromptSubmit`, `PreToolUse`, `SubagentStop`, `PreCompact` |
