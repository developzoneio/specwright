...
| `hooks/powershell/` + `hooks/bash/` | `~/.claude/hooks/sd/` | 4 hooks × 2 platforms (`session-context`, `prompt-router`, `spec-gate`, `subagent-retro`) |
