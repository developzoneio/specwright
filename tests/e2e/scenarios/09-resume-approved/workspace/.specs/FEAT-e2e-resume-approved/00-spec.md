...
# E2E resume-from-approved demo spec (no impact map)

## Why

Seeded fixture spec for tests/e2e/scenarios/09-resume-approved. Gate 1 has passed and the approving session ended
